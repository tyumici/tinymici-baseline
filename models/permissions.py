...
BROADCASTER_ONLY_COMMAND = [UserRestriction(allowed_users=[models.globals._BROADCASTER_NAME])]

# Broadcaster channel siloed commands
BROADCASTER_CHANNEL_MIDDLEWARE = [ChannelRestriction(allowed_channel=[models.globals._BROADCASTER_NAME])]
